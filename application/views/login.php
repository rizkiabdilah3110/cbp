...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo site_url("login/mainmain")?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" id="coba" name="coba" class="form-control" >
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
...
<script>
  $('#username').on('keyup', cobain);
  function cobain(){
    $('#coba').val($('#username').val());
  }

  $('#submit').on('click', bebas);
  function bebas(){
    if($('#username').val()=='');
  }
